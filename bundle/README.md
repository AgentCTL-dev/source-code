...
bundle/
  manifests/
    ...
    agentctl.clusterserviceversion.yaml    # the CSV (agentctl.v1.3.0)
  metadata/
...
- CSV: `agentctl.v1.3.0` (version `1.3.0`, maturity `alpha`, minKubeVersion `1.31.0`)
- Operator image: `ghcr.io/agentctl-dev/operator:1.3.0` (other planes: `apiserver`,
...
```bash
# from the repo root
docker build -f bundle/bundle.Dockerfile -t ghcr.io/agentctl-dev/agentctl-bundle:1.3.0 bundle
docker push ghcr.io/agentctl-dev/agentctl-bundle:1.3.0
```
...
operator-sdk run bundle ghcr.io/agentctl-dev/agentctl-bundle:1.3.0 \
