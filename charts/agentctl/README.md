...
- Chart version / app version: **0.1.0**
...
`image.tag: 0.1.0`), or install the chart straight from the OCI registry:
...
| `referenceAgent.image` | `agentd:1.0.0` | The reference agent image used only by the bundled examples. |
